...
Serial.println("Ready. Waiting for wireless data from hand ESP32...");
  Serial.println();
  Serial.println("Column guide:");
  Serial.println("  timestamp_ms = milliseconds since ESP32 boot");
  Serial.println("  label        = current gesture label (from START:/STOP commands)");
  Serial.println("  aw,ax,ay,az  = Sensor A (forearm) quaternion");
  Serial.println("  bw,bx,by,bz  = Sensor B (hand) quaternion");
  Serial.println();
